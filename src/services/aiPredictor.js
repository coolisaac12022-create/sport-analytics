...
function statisticalPrediction(homeForm, awayForm, leagueName) {
  ...
  return {
    homeWinProb: round(homeWinProb), drawProb: round(drawProb), awayWinProb: round(awayWinProb),
    bttsYesProb: round(bttsYesProb), over15Prob: round(over15Prob), over25Prob: round(over25Prob),
    predictedScore: bestScore, confidence: confidence,
